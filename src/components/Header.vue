				...
				<div class="header__body">
					...
					<div class="header__menu menu">
						<nav class="menu__body" :class="{ '_active': menuIsOpen }">
							<ul class="menu__list">
								<li class="menu__item"><a href="" class="menu__link menu__link_home fas fa-home"><span>home</span></a></li>
								<li class="menu__item"><a href="" class="menu__link"><span>about us</span></a></li>
								<li class="menu__item"><a href="" class="menu__link"><span>our technologies</span></a></li>
								<li class="menu__item"><a href="" class="menu__link"><span>contacts</span></a></li>
							</ul>
						</nav>
					</div>
